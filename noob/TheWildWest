...
if _G.Executed1 then
    game:GetService("Workspace").Ignore.MapZoneBounds:Destroy()
end
...
local AnimalModule, BreakableGlassModule, CameraModule, ClientProjectiles, GunItemModule, NetworkModule, PlayerCharacterModule, SharedUtilsModule, UtilsModule, PlayerDataModule, UIHandlerModule, ProjectileHandlerModule; do
...
SharedUtilsModule.GetNearestShopVendor = function(p87)
	local v173 = nil;
	local v174 = 1500;
	for v175, v176 in pairs(u13) do
		local l__Magnitude__177 = (v176.PrimaryPart.Position - p87).Magnitude;
		if l__Magnitude__177 < v174 then
			v173 = v176;
			v174 = l__Magnitude__177;
		end;
	end;
	return v173;
end;
