    ...
    while task.wait(settings.Delay) do
        if settings.Comp then
            if game:GetService("ReplicatedStorage"):WaitForChild("Remotes") then
                game:GetService("ReplicatedStorage"):WaitForChild("Remotes")SkipStagePrompt:FireServer();
            end
...
spawn(function()
    while task.wait() do
        if settings.Buy then
            ...
            for _, v in pairs(
                game:GetService("Players").LocalPlayer.PlayerGui.MainGUI.Shop.Sections.Tags.Grid:GetChildren()
            ) do
                game:GetService("Players").LocalPlayer.PlayerGui.MainGUI.Shop.Visible = false
                game:GetService("ReplicatedStorage").Remotes.BuyTag:InvokeServer(v.Name)
            end
            for _, v in pairs(
                game:GetService("Players").LocalPlayer.PlayerGui.MainGUI.Shop.Sections.Trails.Grid:GetChildren()
            ) do
                game:GetService("Players").LocalPlayer.PlayerGui.MainGUI.Shop.Visible = false
                game:GetService("ReplicatedStorage").Remotes.BuyTrail:InvokeServer(v.Name)
            end
            for _, v in pairs(
                game:GetService("Players").LocalPlayer.PlayerGui.MainGUI.Shop.Sections.Halos.Grid:GetChildren()
            ) do
                game:GetService("Players").LocalPlayer.PlayerGui.MainGUI.Shop.Visible = false
                game:GetService("ReplicatedStorage").Remotes.BuyHalo:InvokeServer(v.Name)
            end
            for _, v in pairs(
                game:GetService("Players").LocalPlayer.PlayerGui.MainGUI.Shop.Sections.Pets.Grid:GetChildren()
            ) do
                game:GetService("Players").LocalPlayer.PlayerGui.MainGUI.Shop.Visible = false
...
--             CFrame.new(game:GetService("Workspace").Gifts.Gift.Position)
--     else
