...
local NyaHubLib = Instance.new("ScreenGui")
NyaHubLib.Name = "Nyaaaa_x3"
if syn and syn.protect_gui then
    syn.protect_gui(NyaHubLib)
    NyaHubLib.Parent = game.CoreGui
elseif gethui then
    NyaHubLib.Parent = gethui()
else
    NyaHubLib.Parent = game.CoreGui
end
NyaHubLib.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
