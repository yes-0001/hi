if getgenv().nyahub then
    local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/yes-0001/hi/main/NyaHub/UI.lua", true))()
    ...
    b:Button("Teleport to Player",function()
        ...
        local tween = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(1.5), {CFrame = game.Players[Target].character.HumanoidRootPart.CFrame})
        tween:Play()
    ...
    -- Fake messagebox
    game.Players.LocalPlayer:Kick("Sorry, I don't allow stealing of my scripts :)")
end